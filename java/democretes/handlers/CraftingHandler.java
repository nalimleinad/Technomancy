...
public class CraftingHandler {
	...
	public static void initFurnaceRecipe() {
		for(int i = 0; i < 5; i++) {
			FurnaceRecipes.smelting().func_151396_a(TMItems.processedIron, new ItemStack(Items.iron_ingot, 2 + i, 0), 100);
		}
		for(int i = 0; i < 5; i++) {
			FurnaceRecipes.smelting().func_151396_a(TMItems.processedGold, new ItemStack(Items.gold_ingot, 2 + i, 0), 100);
		}
		try{
			for(int i = 0; i < 5; i++) {
				FurnaceRecipes.smelting().func_151396_a(TMItems.processedCopper, new ItemStack(ThermalExpansion.ingotCopper.getItem(),
						2 + i, ThermalExpansion.ingotCopper.getItemDamage()), 100);
			}
			for(int i = 0; i < 5; i++) {
				FurnaceRecipes.smelting().func_151396_a(TMItems.processedTin, new ItemStack(ThermalExpansion.ingotTin.getItem(),
						2 + i, ThermalExpansion.ingotTin.getItemDamage()), 100);
			}
			for(int i = 0; i < 5; i++) {
				FurnaceRecipes.smelting().func_151396_a(TMItems.processedSilver, new ItemStack(ThermalExpansion.ingotSilver.getItem(),
						2 + i, ThermalExpansion.ingotSilver.getItemDamage()), 100);
			}
			for(int i = 0; i < 5; i++) {
				FurnaceRecipes.smelting().func_151396_a(TMItems.processedLead, new ItemStack(ThermalExpansion.ingotLead.getItem(),
						2 + i, ThermalExpansion.ingotLead.getItemDamage()), 100);
			}
			for(int i = 0; i < 5; i++) {
				FurnaceRecipes.smelting().func_151396_a(TMItems.processedNickel, new ItemStack(ThermalExpansion.ingotNickel.getItem(),
	...
	public static void initThaumcraftRecipes() {
		try{
			if(ThermalExpansion.te){
				...
				ResearchHandler.recipes.put("FluxLamp", Thaumcraft.addInfusionCraftingRecipe.invoke(null, "FLUXLAMP",
						new ItemStack(TMBlocks.fluxLamp), 10, new AspectList().add(Aspect.MECHANISM,  45).add(Aspect.TAINT, 45)
						.add(Aspect.ORDER, 45).add(Aspect.LIGHT, 45), new ItemStack(Thaumcraft.blockMetalDevice, 1, 7),
				...
				ResearchHandler.recipes.put("EnergizedWandRod", Thaumcraft.addInfusionCraftingRecipe.invoke(null, "ENERGIZEDWAND",
						...
						.add(Aspect.EXCHANGE, 50),new ItemStack(Thaumcraft.itemWandRod, 1, 1),
						new ItemStack[] { new ItemStack((ThermalExpansion.capacitorResonant).getItem(), 1, 4),
						new ItemStack((ThermalExpansion.powerCoilElectrum).getItem(), 1, 193), new ItemStack((ThermalExpansion.powerCoilSilver)
						.getItem(), 1, 194), new ItemStack((ThermalExpansion.powerCoilGold).getItem(), 1, 195), new ItemStack(TMItems.itemMaterial,
						1, 1) }));
				...
				ResearchHandler.recipes.put("EssentiaDynamo", Thaumcraft.addArcaneCraftingRecipe.invoke(null, "DYNAMO",
						new ItemStack(TMBlocks.essentiaDynamo, 1, 0), new AspectList().add(Aspect.WATER, 15).add(Aspect.ORDER, 10)
						.add(Aspect.FIRE, 5).add(Aspect.ENTROPY, 25), new Object[] {" C ", "GIG", "IWI",
					'W', new ItemStack(Thaumcraft.blockJar, 1, 0),
					'C', new ItemStack(TMItems.itemMaterial, 1, 1),
					'G', new ItemStack(TMItems.itemMaterial, 1, 2),
					'I', new ItemStack(Thaumcraft.blockTube, 1, 0),				}));	
				ResearchHandler.recipes.put("BiomeMorpher", Thaumcraft.addArcaneCraftingRecipe.invoke(null, "BIOMEMORPHER",
						new ItemStack(TMBlocks.biomeMorpher), new AspectList().add(Aspect.EARTH, 30).add(Aspect.ORDER, 30).add(Aspect.WATER, 30), 
					...
					'G', new ItemStack(TMItems.itemMaterial, 1, 2),
					'C', new ItemStack(TMItems.itemMaterial, 1, 1)		}));
				ResearchHandler.recipes.put("TeslaCoil", Thaumcraft.addArcaneCraftingRecipe.invoke(null, "TESLACOIL",
						new ItemStack(TMBlocks.teslaCoil), new AspectList().add(Aspect.WATER, 20).add(Aspect.ORDER, 20).add(Aspect.ENTROPY, 20)
						.add(Aspect.AIR, 20).add(Aspect.FIRE, 20) .add(Aspect.EARTH, 20), new Object[] {" N ", " C ", "TBT",
				...
				ResearchHandler.recipes.put("CoilCoupler", Thaumcraft.addArcaneCraftingRecipe.invoke(null, "TESLACOIL",
						new ItemStack(TMItems.itemMaterial, 1, 4), new AspectList().add(Aspect.AIR, 10).add(Aspect.ORDER, 15),
						new Object[] {" C ", " T ", " S ",
					'C', new ItemStack(TMItems.itemMaterial, 1, 1),
					'T', new ItemStack(Thaumcraft.itemResource, 1, 2),
					'S', new ItemStack(Items.stick)	}));
				ResearchHandler.recipes.put("ElectricBellows", Thaumcraft.addArcaneCraftingRecipe.invoke(null, "ELECTRICBELLOWS",
						new ItemStack(TMBlocks.electricBellows, 1, 0), new AspectList().add(Aspect.AIR, 30).add(Aspect.ORDER, 30)
						.add(Aspect.FIRE, 30), new Object[] {"TG ", "EBC", "TG ",
					'T', new ItemStack(Thaumcraft.itemResource, 1, 2),
					'G', new ItemStack(TMItems.itemMaterial, 1, 2),
					'E', ThermalExpansion.cellBasicFrame,
					'B', new ItemStack(Thaumcraft.blockWoodenDevice, 1, 0),
					'C', new ItemStack(TMItems.itemMaterial, 1, 1)				}));
				ResearchHandler.recipes.put("Processor", Thaumcraft.addArcaneCraftingRecipe.invoke(null, "PROCESSOR",
						new ItemStack(TMBlocks.processorTC, 1, 0), new AspectList().add(Aspect.FIRE, 25).add(Aspect.ENTROPY, 25)
						.add(Aspect.ORDER, 25), new Object[] {" A ", "BMB", "ICI",
				...
				//Crucible Recipes
				ResearchHandler.recipes.put("NeutronizedMetal", Thaumcraft.addCrucibleRecipe.invoke(null, "THAUMIUM", 
					new ItemStack(TMItems.itemMaterial, 1, 0), new ItemStack(Thaumcraft.itemResource, 1, 2), new AspectList()
					.add(Aspect.ORDER, 2).add(Aspect.ENERGY, 2)));
				...
				Thaumcraft.addArcaneCraftingRecipe.invoke(null, "ENERGIZEDWAND", electric, new AspectList().add(Aspect.AIR, 60)
						.add(Aspect.ORDER, 60).add(Aspect.EARTH, 60).add(Aspect.FIRE, 60).add(Aspect.WATER, 60).add(Aspect.ENTROPY, 60), 
						new Object[]{"  C", " R ", "C  ", 
				...
				ResearchHandler.recipes.put("EnergizedWandRod", Thaumcraft.addInfusionCraftingRecipe.invoke(null, "ENERGIZEDWAND",
					...
					new AspectList().add(Aspect.ENERGY, 50).add(Aspect.TOOL, 50).add(Aspect.MAGIC, 50).add(Aspect.MECHANISM, 50)
					.add(Aspect.EXCHANGE, 50),new ItemStack(Thaumcraft.itemWandRod, 1, 1), new ItemStack[] {new ItemStack(Blocks.redstone_block, 1)
	...
	static ItemStack getItem(int ID, String ItemsString, int meta) {
		ItemStack stack = null;
		try {
			String itemClass = null;
			switch(ID) {
			case 0:
				itemClass = "vazkii.botania.common.Items.ModItems";
			case 1:
				itemClass = "WayofTime.alchemicalWizardry.ModItems";	    	
			}
			Object obj = Class.forName(itemClass).getField(ItemsString).get(null);
			...
			FMLLog.warning("[Technomancy] Could not retrieve Items identified by: " + ItemsString, new Object[0]);
		}
		return stack;
	}

	static ItemStack getBlock(int ID, String ItemsString, int meta) {
		ItemStack stack = null;
		String ItemsClass = null;
		try{
			switch(ID) {
			case 0:
				ItemsClass = "vazkii.botania.common.Blocks.ModBlocks";
			case 1:
				ItemsClass = "WayofTime.alchemicalWizardry.ModBlocks";
			}
			Object obj = Class.forName(ItemsClass).getField(ItemsString).get(null);
			...
			FMLLog.warning("[Technomancy] Could not retrieve block identified by: " + ItemsString + " at: " + ItemsClass, new Object[0]);
		}
		return stack;
	}
}