...
public class TileManaFabricatorRenderer extends TileEntitySpecialRenderer{
	...
	private static final ResourceLocation modelTexture = new ResourceLocation(Ref.MOD_ID.toLowerCase(),Ref.MODEL_MANA_FABRICATOR_TEXTURE);
	...
	public void renderFacing(TileEntity entity) {
		switch (((TileManaFabricator)entity).facing){
		case 0:
